// 14 February 2007, modified 11 July 2014.
// Uhoo Algorithm
...
xstring(-9.1,-5.3,'');// WAS ALPHA
xarc(-7,-3,4,4,0*64,360*64)//vertex at (-5,-5)
xstring(7.4,-5.3,'');// WAS BETA
...
// Use a compass of quantity theta and cast rays that intersect 'b' and 'c' continuing to twice the distance:
...
// Now agents can traverse the paths and access each of the dataspaces assigned by a coordinate of three points.
...
// Title the result
xstring(3.5,-16,'Graph of the algorithm');
